...
import { vacationsActionCreators, vacationsReducersContainer } from "../Redux/VacationsSlice";
...
class VacationService {
    ...
    public async getAllVacations(): Promise<VacationModel[]> {
        ...
        // Get all vacations from backend: 
        const response = await axios.get<VacationModel[]>(appConfig.vacationsByUserUrl + user.id);
    ...
    public async addVacation(product: VacationModel): Promise<void> {
        ...
        const response = await axios.post<VacationModel>(appConfig.vacationsUrl, product, appConfig.axiosOptions);
    ...
    public async updateVacation(product: VacationModel): Promise<void> {
        ...
        const response = await axios.put<VacationModel>(appConfig.vacationsUrl + product.id, product, appConfig.axiosOptions);
